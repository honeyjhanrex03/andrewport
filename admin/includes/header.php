...
$admin_avatar = (!empty($admin_profile['profile_image'])) ? get_asset_url($admin_profile['profile_image']) : 'https://ui-avatars.com/api/?name=Admin&background=1e212b&color=ff6b57';
