        ...
        for ($i = 0; $i < $total; $i++) {
            if ($_FILES[$fileInput]['error'][$i] == 0) {
                ...
                if (move_uploaded_file($_FILES[$fileInput]['tmp_name'][$i], $uploadDir . $filename)) {
                    $paths[] = '/andrew/assets/images/' . $filename;
                }
            }
        }
    }
                    ...
                    <div class="mb-3">
                        ...
                        <?php if(!empty($p['image_path'])): ?>
                            <div class="mt-2 p-2 border rounded bg-light d-inline-block">
                                <img src="<?= htmlspecialchars($p['image_path']) ?>" style="height: 40px;">
                        ...
                        ?>
                            <div class="mt-2 p-2 border rounded bg-light">
                                ...
                                <?php foreach($current_additional as $img): ?>
                                    <img src="<?= htmlspecialchars($img) ?>" class="me-2 rounded border" style="height: 40px; width: 40px; object-fit: cover;">
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
                    </div>
